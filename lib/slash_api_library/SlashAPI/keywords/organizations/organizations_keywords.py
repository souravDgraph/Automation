...
class OrganizationsKeywords:
    ...
    def remove_member_from_existing_organization(self, org_name, member_email, appender=None):
        ...
        """
        if appender:
            return self.org_handler.remove_member_from_organization(org_name, member_email, appender)
        else:
            return self.org_handler.remove_member_from_organization(org_name, member_email)
