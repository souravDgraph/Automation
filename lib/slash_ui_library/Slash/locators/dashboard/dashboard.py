...
class DashboardLocators:
    ...
    organization_button = "xpath = //button[text()='Organizations']"
    organization_info = "xpath = //div[text()='Organizations give you the ability to add other users with view and edit permission to the same backend.']"
    ...
    invalid_card_message = "xpath = //div[text()='Your card number is invalid.']"
    invalid_icon = "xpath = //div[@class='CardBrandIcon-container' and@data-front-icon-name='error']"
    ...
    clone_button = "xpath = //button[text()='Clone']"
    billing_label = "xpath = //h3[text()='Billing']"
    billing_button = "xpath = //button[text()='Billing']"
    backend_name_button = "xpath = //button[@class='css-dlcyd9']//div[text()='%s']"
    backend_name_list = "xpath = //button[@class='css-dlcyd9']//following-sibling::ul//div[text()='%s']"
    backend_instance_type = "xpath = //div[text()='Instance Type']//following::div[text()='%s']"
    backend_storage = "xpath = //div[text()='%s']"
    backend_name_in_overview = "xpath = //h3[text()='%s']"
